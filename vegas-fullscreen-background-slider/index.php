...
<p>Shortcode: <input type="text" spellcheck="false" onclick="this.focus();this.select()" readonly="readonly"
value='<?php $shortcodeid = get_the_ID(); echo '[vegasslider id="' . $shortcodeid . '" fade="' . $fade . '" delay="' . $delay . '" overlay="' . $overlay . '" title="' . $title . '" arrows="' . $arrows . '" autoplay="' . $autoplay . '" where="' .$where. '"]';?>'></p>
...
// place js config array for plupload
    $plupload_init = array(
        ...
        'drop_where' => 'drag-drop-area', // will be adjusted per uploader
...
extract(shortcode_atts(array('id','where'=>'body','fade' => '1500','overlay','title','arrows','delay' => '4000','autoplay' => 'yes'), $atts));
...
if(!isset($atts['where']) || $atts['where']=='')
	$atts['where'] = 'body';

if(!isset($atts['fade']) || $atts['fade']=='')
	$atts['fade'] = '900';
?>
<?php //var_dump($atts);?>
...
echo do_shortcode( '[vegasslider id="' . $shortcodeid . '" fade="' . $fades . '" delay="' . $delay . '" overlay="' . $overlay . '" title="' . $title . '" arrows="' . $arrows . '" autoplay="' . $autoplay . '" where="' . $where . '"]' );
}
