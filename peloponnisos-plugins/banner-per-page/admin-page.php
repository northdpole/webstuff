...
//all it needs is just a check in get_category_banner to return the color if it doesn't have an image
function _banner_my_category_custom_fields( $tag ) {
	...
	<p id="_bpp_color_description" class="description">Use a banner colour as well as or instead of an image.</p>
      </div>
             </td>
    </tr>
    <?php
...
function _banner_save_my_category_custom_fields() {
...
function _banner_setup_category_image_handling() {
...
function _banner_category_image( $tag ) {
   ...
   function _banner_fix_async_upload_image() {
   ...
   function _banner_is_category_context() {
   ...
   function _banner_category_image_replace_text_in_thickbox($translated_text, $source_text, $domain) {
   ...
   function _banner_category_image_send_to_editor( $html, $id, $attachment ) {
   ...
   function _banner_category_image_send_script() { ?>
       <script>
           self.TI = {};
           var tb_position;
...
function _banner_get_category_banner($term_id){
